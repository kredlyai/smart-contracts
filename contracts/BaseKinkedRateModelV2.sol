...
/**
 * @title Logic for Compound's KinkedRateModel Contract V2.
 * @author Compound (modified by Dharma Labs, Arr00 and Kredly)
 ...
 */
abstract contract BaseKinkedRateModelV2 is InterestRateModel {
    /**
     ...
     */
    function updateKinkedRateModel(
        uint256 baseRatePerYear,
        uint256 multiplierPerYear,
        uint256 jumpMultiplierPerYear,
        uint256 kink_
        ...
        string
            memory signature = "updateKinkedRateModel(uint256,uint256,uint256,uint256)";
    ...
    function utilizationRate(
        ...
        uint256 rate = ((borrows + badDebt) * EXP_SCALE) /
     ...
     * @param kink_ The utilization point at which the jump multiplier is applied
     */
    function _updateKinkedRateModel(
        uint256 baseRatePerYear,
        uint256 multiplierPerYear,
        uint256 jumpMultiplierPerYear,
        uint256 kink_
    ...
    function _getBorrowRate(
        ...
        uint256 normalRate = ((kink_ * multiplierPerBlock) / EXP_SCALE) +
            baseRatePerBlock;
        uint256 excessUtil;
        unchecked {
